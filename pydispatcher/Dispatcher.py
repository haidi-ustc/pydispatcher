...
from pydispatcher.LocalContext import LocalSession
from pydispatcher.LocalContext import LocalContext
from pydispatcher.LazyLocalContext import LazyLocalContext
from pydispatcher.SSHContext import SSHSession
from pydispatcher.SSHContext import SSHContext
from pydispatcher.Slurm import Slurm
from pydispatcher.LSF import LSF
from pydispatcher.PBS import PBS
from pydispatcher.Shell import Shell
from pydispatcher.AWS import AWS 
...
def make_dispatcher(mdata, mdata_resource=None, work_path=None, run_tasks=None, group_size=None):
    if 'cloud_resources' in mdata:
        if mdata['cloud_resources']['cloud_platform'] == 'ali':
            from pydispatcher.ALI import ALI
